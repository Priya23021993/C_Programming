...
//  Description:    It is use to accept range from user and return addition of all even
//                  numbers in between that range(range should contains + numbers only)
//  Input:          integer
//  Output:         integer
...
int RangeSumEven(  int iStart ,                               //Firat input
